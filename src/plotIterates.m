 ...
 if i == 2
     initializePlots;
     line(plotStepSizes,i-1,log10(iter.logg.localStepS(i-1)),'Marker','.', ...
             'MarkerSize', 5, 'Color', 'black', 'HandleVisibility', 'on', ...
             'DisplayName', 'local step size');
     line(plotStepSizes,i-1,log10(iter.logg.QPstepS(i-1)),'Marker', '.',...
 ...
 elseif i >= 2
     ...
     line(plotConsViol, i-1,log10(iter.logg.consViol(i-1)), 'Marker', '.',...
