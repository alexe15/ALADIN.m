classdef  PrintOptiStack < SwigRef
    %PRINTOPTISTACK Base class for objects that have a natural string representation.
    %
    %
    %
    %Joel Andersson
  ...
  methods
    ...
    function self = PrintOptiStack(varargin)
    %PRINTOPTISTACK 
    %
    %  new_obj = PRINTOPTISTACK()
    %
    %
