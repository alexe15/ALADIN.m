classdef  PrintIM < SwigRef
    %PRINTIM Base class for objects that have a natural string representation.
    %
    %
    %
    %Joel Andersson
  ...
  methods
    ...
    function self = PrintIM(varargin)
    %PRINTIM 
    %
    %  new_obj = PRINTIM()
    %
