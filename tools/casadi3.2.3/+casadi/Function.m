classdef  Function < casadi.SharedObject
  ...
  methods
    ...
    %
    %  Function = JACOBIAN_OLD(self, int iind, int oind, bool compact, bool symmetric)
    %
    %
    %Parameters:
    %-----------
    ...
    %JACOBIAN [INTERNAL]  Generate a Jacobian function of output oind with respect to
    %
    ...
    %
    %
    %> JACOBIAN(self, char iind, int oind, bool compact, bool symmetric)
    %> JACOBIAN(self, int iind, char oind, bool compact, bool symmetric)
    %> JACOBIAN(self, char iind, char oind, bool compact, bool symmetric)
    %------------------------------------------------------------------------
    %
    %
    ...
    %SETJACOBIAN [DEPRECATED] Set the Jacobian function of output oind with respect to input
    %
    ...
    %SETFULLJACOBIAN [DEPRECATED] Set the Jacobian of all the input nonzeros with respect to all
    %
    ...
    %GRADIENT [DEPRECATED] Use Function::factory instead
    %
    ...
    %TANGENT [DEPRECATED] Use Function::factory instead
    %
    ...
    %HESSIAN [DEPRECATED] Alias of Function::jacobian_old This function is of internal
    %
    ...
    %SPARSITY_JAC [INTERNAL] 
    %
    %  Sparsity = SPARSITY_JAC(self, int iind)
    ...
    %SET_JAC_SPARSITY [DEPRECATED] Generate the sparsity of a Jacobian block
    %
    ...
    %ROOTFINDER_FUN [DEPRECATED] Use oracle() instead
    %
