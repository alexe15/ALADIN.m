classdef  MX < casadi.ExpMX & casadi.GenMX & casadi.SharedObject
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(726, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(727, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(745, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(746, varargin{:});
    end
