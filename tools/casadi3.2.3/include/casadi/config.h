...
#define CASADI_VERSION_STRING "3.2.3"
#define CASADI_GIT_REVISION "c08a0a27ed62dcf37f3ed615994dca406d6a7617"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.2.2-15.c08a0a27e"  // NOLINT(whitespace/line_length)
